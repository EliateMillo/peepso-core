<?php /**/
...
class PeepSo3_REST_V1_Endpoint_File_Upload extends PeepSo3_REST_V1_Endpoint {
    ...
    public function create() {
        if (count($_FILES) > 0 && isset($_FILES['filedata'])) {
            ...
            $dir = PeepSoFileUploads::get_upload_dir($this->user_id, 0, 0);
