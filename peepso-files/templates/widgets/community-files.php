<?php /**/
...
<div class="ps-widget__wrapper<?php echo $instance['class_suffix']; ?> ps-widget<?php echo $instance['class_suffix']; ?> ps-js-widget-latest-files"
        ...
        <script type="text/template" data-name="item-template">
            <div class="ps-file-item-wrapper" data-id="{{= data.id }}">
                ...
                <div class="ps-file-item-action">
                    <a class="ps-tip ps-tip--arrow" aria-label="<?php echo __('Download', 'peepsofileuploads') ?>" href="{{= data.download_link }}" download="{{= data.name }}" target="_blank">
