<div class="peepso">
  <div class="ps-page ps-page--page ps-page--page-settings">
    <?php /**/ PeepSoTemplate::exec_template('general','navbar'); ?>
    <?php PeepSoTemplate::exec_template('general', 'register-panel'); ?>

    <?php if(get_current_user_id()) { ?>
      <div class="ps-page__edit">
        <?php
        PeepSoTemplate::exec_template('pages', 'page-header', array('page'=>$page, 'page_segment'=>$page_segment));
