...
//        );
    ...
    public function readme() {
        ...
        $this->set_field(
            ...
            '![Alt text](https://www.peepso.com/wp-content/uploads/2024/05/logo.svg) - for embedding images from other sources. These images will NOT be saved within your website. They are just linked to.<br/><br/>' .
