<?php /*NWJjbDNsYng1QmhMczU4UHdsd3hjUDMzNXdIYzBoR3lkQzFSQnluZXVPaW5BNGtPQ2pMU0tSV1lVOUdmOE4zak93SWhhdWJ2aVRtREZhdzY0U0RTN1UrTG9YeVZKRjVoZC9TLzVIWGdjMm1lR0VGNHkxSTMxMFhDQ2NLeGIvTmpBMWJxVHhwcWRWYnZLSTdXbjI4WWVWNDJXd3htdEl6NXJhZVlHSFdMa3FBPQ==*/
get_header();
...
<div id="main" class="main <?php echo $main_class; if ($full_width_layout == 1) : echo " main--full"; endif; if ($builder_friendly_layout == 1) : echo " main--builder"; endif; ?>">
  ...
  <div <?php if($content_id) : ?>id="<?php echo $content_id;?>"<?php endif; ?> class="content">
    ...
    <?php if ( have_posts() ) : ?>
      <div class="content__posts" <?php echo $content_id ? 'data-gc-masonry style="display:none"' : '' ?>>
      <?php
      // Start the loop.
