<?php /*NWJjbDNsYng1QmhMczU4UHdsd3hjUDMzNXdIYzBoR3lkQzFSQnluZXVPalRPazl6WEFCZXNQd0ZEYWQrWWJHRzJGTG9NYThaMmtmdlhJQ05aVjZnTS9ZRUs3TEtySi9iNjMyQjNzT285SlF0MS82Y25FNjB5OW1qa09ncXpVd1QrdlpFOGsxVmFlZDRFMm5PaDNONHdwc0ZUcmhENEVTOFA3UTl6YlBOaUdNPQ==*/
get_header();
...
<div id="main" class="main <?php echo $main_class; if ($full_width_layout == 1) : echo " main--full"; endif; if ($builder_friendly_layout == 1) : echo " main--builder"; endif; ?>">
  <div class="content">
    ...
    <?php if ( have_posts() ) : ?>
      <div class="content__posts <?php if($content_id) { echo $content_id; } ?>" <?php echo $content_id ? 'data-gc-masonry style="display:none"' : '' ?>>
      <?php
      // Start the loop.
