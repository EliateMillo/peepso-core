<?php /*NWJjbDNsYng1QmhMczU4UHdsd3hjUDMzNXdIYzBoR3lkQzFSQnluZXVPaDEwb0Y0SHV6ZTNVdXR4bEt2ZWR1MHhHRFl6SWlDYVRDSTlMNW8rTzNuQzhiL0kzamtTSStXQXBuMFNqWVNJdGZPTE1IdkJYdFhHVGgzcnRVSEN6WFJmUHpzMnBYYStmQjM0cDZzeW9xRm5UaDBHRTlwaGNZVkFlRWJZcjJxVkFBPQ==*/
...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
	...
	<footer class="entry-footer">
		<?php if ($gecko_settings->get_option( 'opt_blog_single_post_category', 1 )) : ?>
			<?php if (is_blog() || is_home()) : ?>
