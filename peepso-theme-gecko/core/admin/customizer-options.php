<?php /**/
                  ...
                  'config-body-class' => [
					...
					'Sidenav' => [
						...
						'settings' => [
                            ...
                            'gc-sidenav-search' => [
                                'name' =>__('Sidenav search', 'peepso-theme-gecko'),
                                'id' => 'gc-sidenav-search',
                                'type' => 'switch',
                                'var' => '--c-gc-sidenav-search-vis',
                                'on' => 'block',
                                'off' => 'none',
                            ],
							// Logo
				...
				'options' => [
					'blog-general' => [
						...
						'settings' => [
							...
							'gc-blog-single-post-category' => [
								'name' => __('Show categories on Blog posts.', 'peepso-theme-gecko'),
								'desc' => __('Enable displaying categories on posts in the main blog view.', 'peepso-theme-gecko'),
								'id' => 'gc-blog-single-post-category',
								'type' => 'switch',
								'setting' => 'opt_blog_single_post_category',
								'on' => '1',
								'off' => '',
							  ],
