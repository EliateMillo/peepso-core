<?php /*NWJjbDNsYng1QmhMczU4UHdsd3hjUDMzNXdIYzBoR3lkQzFSQnluZXVPaG1IN3Bpd3paczlZbnc4ZWpsamJaeThsY1BnaFRiMHNndUVlZjVkREx2b1MxbW03TEVCYzlUOVp3dWRzVVE0djVMaTloaXp3dXhVZWl1b1hFRnoyRVBBVjRCUTI5VUpkekFPbTF2azJYWDE0MkF1NEkrZU1XZ203am0yZmdtME8wPQ==*/
/**
                    ...
                    <div class="gca-dash__content">
                      <div class="gca-dash__settings">
                        ...
                        <div class="gca-dash__settings-group">
                          ...
                          <div class="gca-dash__settings-group">
                              <div class="gca-dash__settings-name"><i class="gcis gci-user-cog"></i><?php esc_html_e( 'Elementor', 'peepso-theme-gecko' ); ?></div>

                              <div class="gca-dash__options">
                                  <div class="gca-dash__option">
                                      <div class="gca-dash__option-name"><?php esc_html_e( 'Header & Footer Support', 'peepso-theme-gecko' ); ?><span class="gca-dash__label"><?php esc_html_e( 'Beta', 'peepso-theme-gecko' ); ?></span></div>
                                      <?php
                                      $gecko_settings = GeckoConfigSettings::get_instance();
                                      $value = $gecko_settings->get_option( 'opt_elementor_headerfooter', 0 );
                                      ...
                                      ?>
                                      <select name="gecko_options[opt_elementor_headerfooter]" id="gecko_options[opt_elementor_headerfooter]">
                                          <?php foreach($options as $key=>$label) { ?>
                                              <option <?php echo ($key==$value) ? 'selected' : '' ;?> value="<?php echo $key;?>"><?php echo $label;?></option>
                                          <?php } ?>
                                      </select>
