<?php /**/
	...
	class Gecko_Customizer_Preset {
		...
		protected function get_default() {
			...
			$settings = [
				...
				'opt_blog_sidebars' => '1',
				'opt_blog_single_post_category' => '1',
				'opt_limit_blog_post' => '',
			...
			if($defaults) {
                ...
                $presets['dark'] = [
                    ...
                    'css_vars' => array_merge($default_css_vars, [
											...
											'--c-ps-postbox-type-bg' => '#222222',
											'--c-ps-postbox-type-bg-hover' => '#292929',
                    ]),
                ];
