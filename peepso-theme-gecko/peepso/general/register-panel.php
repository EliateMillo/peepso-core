<?php /**/ if ( ! is_user_logged_in()) {
$activated = FALSE;
      ...
      <div class="ps-landing__cover-inner">
        <div class="ps-landing__content">
          <div class="ps-landing__title">
            ...
            <?php else : ?>
              <?php echo PeepSo::get_option('site_registration_header', __('Get Connected!', 'peepso-theme-gecko'), TRUE); ?>
            <?php endif; ?>
          </div>
          <div class="ps-landing__text">
            ...
            <?php else : ?>
              <?php echo PeepSo::get_option('site_registration_callout', __('Come and join our community. Expand your network and get to know new people!', 'peepso-theme-gecko'), TRUE); ?>
            <?php endif; ?>
          </div>
        </div>
        ...
        <?php if (!$is_mobiloud) { ?>
          ...
          <div class="ps-landing__actions">
            <a class="ps-btn ps-btn--sm ps-btn--cp ps-btn--join" href="<?php echo PeepSo::get_page('register'); ?>">
              <?php echo PeepSo::get_option('site_registration_buttontext', __('Join us now, it\'s free!', 'peepso-theme-gecko'), TRUE); ?>
            </a>
          </div>
          <?php } ?>
        <?php } ?>
