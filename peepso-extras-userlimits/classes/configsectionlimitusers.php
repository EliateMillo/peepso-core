<?php /**/
...
// Builds the groups array
	public function register_config_groups()
	{
       ...
       $this->set_field(
        ...
        // pages
        if(class_exists('PeepSoPages')) {
            $this->box(
                'pages',
                __('Pages - like', 'peepsolimitusers'),
                __('Controls like pages and being invited to pages.<br/>Does not affect pages created earlier.', 'peepsolimitusers')
            );
        }
        ...
        if(class_exists('PeepSoPages')) {
            $this->box(
                'pages_create',
                __('Pages - create', 'peepsolimitusers'),
                __('Controls page creation.<br/>Does not affect pages created earlier.', 'peepsolimitusers')
            );
        }
