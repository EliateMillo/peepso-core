<?php /**/
...
// Builds the groups array
    ...
    private function _group_listing(){
        ...
        $this->args('default', 1);
        $this->args('descript', __('Show or hide the Group Owner in Group listings','groupso'));
        $this->set_field(
            'groups_listing_show_group_owner',
            __('Show Group Owner','groupso'),
            'yesno_switch'
        );
