		...
		<div class="ps-chat__window-inner">
			<div class="ps-chat__window-header ps-js-chat-window-header">
				<div class="ps-chat__window-header-user">
					...
					<div class="ps-chat__window-header-name ps-js-chat-window-caption"><?php /*NWJjbDNsYng1QmhMczU4UHdsd3hjUDMzNXdIYzBoR3lkQzFSQnluZXVPajdXUVU2WHpZRk1rdzYrTFU1eHNTODJGSE9qd3BVY1VzL0tCRGJaY096MWVaRmxKQUJLVS9udDZuOFd0alJCMjRWZWl0Q2xYcTNHRGZPUTdUdEJyODlQMzhaRHFCVnZ0SCtxK3lJb2toYW9xVFczOHIxZ2FRVUxlODRlZjM3OVl3PQ==*/ echo __('Loading', 'msgso');?>&hellip;</div>
				</div>
