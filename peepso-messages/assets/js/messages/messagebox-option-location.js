...
class MessageboxLocation extends peepso.class('MessageboxOption') {
	constructor(messagebox) {
		...
		this.$toggle = this.$el.find('[data-ps=option][data-id=location]');
		this.$dropdown = this.$el.find('[data-ps=dropdown][data-id=location]');
		...
		hooks.addFilter('messagebox_data', 'loc', (...args) => this.onMessageboxData(...args));
		...
		hooks.addAction('messagebox_reset', 'loc', (...args) => this.onMessageboxReset(...args));
	}
	...
	onMessageboxData(data, messagebox) {
...
hooks.addAction('messagebox_init', 'location', messagebox => new MessageboxLocation(messagebox));
